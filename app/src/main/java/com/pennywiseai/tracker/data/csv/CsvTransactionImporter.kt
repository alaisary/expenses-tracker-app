...
/**
 * Parses غوازي's own CSV export format (the 12 columns [CsvExporter] writes)
...
class CsvTransactionImporter @Inject constructor() {
    ...
    companion object {
        ...
        private const val DEFAULT_CURRENCY = "OMR"
    }
            ...
            if (dateIdx == null || amountIdx == null || typeIdx == null) {
                ...
                return ImportParseResult(
                    ...
                    failureReasons = listOf(
                        "This doesn't look like a غوازي CSV export — missing column(s): $missing"
                    )
                )
            }
