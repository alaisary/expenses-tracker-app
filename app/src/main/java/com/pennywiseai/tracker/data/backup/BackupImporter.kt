...
class BackupImporter @Inject constructor(
    ...
    private val categoryRepository: com.pennywiseai.tracker.data.repository.CategoryRepository
) {
    ...
    suspend fun importBackup(
        ...
        try {
            ...
            // A restored backup may predate categories added since it was taken —
            // backfill the missing built-ins so the post-restore state is complete.
