 ...
 */
@StringRes
fun AccountType.displayNameRes(): Int = when (this) {
    AccountType.SAVINGS -> R.string.filter_account_savings
    AccountType.CURRENT -> R.string.filter_account_current
    AccountType.CREDIT -> R.string.filter_account_credit_card
    AccountType.CASH -> R.string.filter_account_cash
}
