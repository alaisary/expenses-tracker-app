...
class RecentTransactionsWidget : GlanceAppWidget() {
    ...
    private fun Header() {
        ...
        Box(
            ...
            Text(
                text = context.getString(R.string.widget_name_recent),
                style = TextStyle(
            ...
            Box(
                ...
                Box(
                    ...
                    Image(
                        ...
                        contentDescription = context.getString(R.string.widget_name_add_transaction),
    ...
    private fun Summary(totalSpent: java.math.BigDecimal, currency: String) {
        ...
        Column(
            ...
            Text(
                text = context.getString(R.string.wid_total_spend_this_month),
                style = TextStyle(
                    color = GlanceTheme.colors.onSurfaceVariant,
                    fontSize = 13.sp
                )
    ...
    private fun EmptyState() {
        ...
        Column(
            ...
            Text(
                text = context.getString(R.string.wid_no_transactions_yet),
                style = TextStyle(
                    color = GlanceTheme.colors.onSurfaceVariant,
                    fontSize = 13.sp
                )
            ...
            Spacer(modifier = GlanceModifier.height(2.dp))
            Text(
                text = context.getString(R.string.wid_tap_plus_to_add),
                style = TextStyle(
                    color = GlanceTheme.colors.onSurfaceVariant,
                    fontSize = 12.sp
                )
