...
class CategoryPieWidget : GlanceAppWidget() {
    ...
    private fun PieWidgetContent(data: CategoryPieWidgetData) {
        ...
        Column(
            ...
            Row(modifier = GlanceModifier.fillMaxWidth()) {
                Text(
                    text = context.getString(R.string.wid_spending),
                    style = TextStyle(
                ...
                Row(
                    ...
                    Box(contentAlignment = Alignment.Center) {
                        Image(
                            ...
                            contentDescription = context.getString(R.string.wid_spending_by_category),
    ...
    private fun EmptyPie() {
        ...
        Column(
            ...
            Text(
                text = context.getString(R.string.wid_no_spending_yet),
                style = TextStyle(
                    color = GlanceTheme.colors.onSurfaceVariant,
                    fontSize = 12.sp
                )
