...
object CategoryMapping {
    ...
    val categories = mapOf(
        ...
        "Zakat & Sadaqah" to CategoryInfo(
            displayName = "Zakat & Sadaqah",
            icon = Icons.Default.VolunteerActivism,
            color = Color(0xFF2E7D32),
            fallbackIcon = Icons.Default.Savings
        ),
        "Remittances" to CategoryInfo(
            displayName = "Remittances",
            icon = Icons.Default.SwapHoriz,
            color = Color(0xFF00838F),
            fallbackIcon = Icons.Default.AccountBalance
        ),
        "Gold & Jewellery" to CategoryInfo(
            displayName = "Gold & Jewellery",
            icon = Icons.Default.Diamond,
            color = Color(0xFFFFB300),
            fallbackIcon = Icons.Default.ShoppingBag
        ),
        "Gifts & Eidiya" to CategoryInfo(
            displayName = "Gifts & Eidiya",
            icon = Icons.Default.CardGiftcard,
            color = Color(0xFFE91E63),
            fallbackIcon = Icons.Default.ShoppingBag
        ),
        "Hospitality & Majlis" to CategoryInfo(
            displayName = "Hospitality & Majlis",
            icon = Icons.Default.LocalCafe,
            color = Color(0xFF8D6E63),
            fallbackIcon = Icons.Default.Restaurant
        ),
        "Domestic Help & Driver" to CategoryInfo(
            displayName = "Domestic Help & Driver",
            icon = Icons.Default.CleaningServices,
            color = Color(0xFF546E7A),
            fallbackIcon = Icons.Default.Face
        ),
        "Government Fees & Fines" to CategoryInfo(
            displayName = "Government Fees & Fines",
            icon = Icons.Default.Gavel,
            color = Color(0xFF455A64),
            fallbackIcon = Icons.Default.Receipt
        ),
        "Rent & Housing" to CategoryInfo(
            displayName = "Rent & Housing",
            icon = Icons.Default.Home,
            color = Color(0xFF5D4037),
            fallbackIcon = Icons.Default.Home
        ),
        "Housing" to CategoryInfo(
            displayName = "Housing",
            icon = Icons.Default.Home,
            color = Color(0xFF5D4037),
            fallbackIcon = Icons.Default.Home
        ),
        "Loans & EMIs" to CategoryInfo(
            displayName = "Loans & EMIs",
        ...
        "Subscriptions" to CategoryInfo(
            displayName = "Subscriptions",
            icon = Icons.Default.Autorenew,
            color = Color(0xFF7B1FA2),
            fallbackIcon = Icons.Default.Receipt
        ),
        "Fuel" to CategoryInfo(
            displayName = "Fuel",
            icon = Icons.Default.LocalGasStation,
            color = Color(0xFFF57C00),
            fallbackIcon = Icons.Default.DirectionsCar
        ),
        "Refunds" to CategoryInfo(
            displayName = "Refunds",
            icon = Icons.Default.Replay,
            color = Color(0xFF4CAF50),
            fallbackIcon = Icons.AutoMirrored.Filled.TrendingUp
        ),
        "Cashback" to CategoryInfo(
            displayName = "Cashback",
            icon = Icons.Default.Savings,
            color = Color(0xFF66BB6A),
            fallbackIcon = Icons.Default.Savings
        ),
        "Interest" to CategoryInfo(
            displayName = "Interest",
            icon = Icons.Default.Percent,
            color = Color(0xFF00ACC1),
            fallbackIcon = Icons.AutoMirrored.Filled.TrendingUp
        ),
        "Dividends" to CategoryInfo(
