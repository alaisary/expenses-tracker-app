...
fun PermissionScreen(
    ...
    PennyWiseScaffold(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.onb_permission_title),
            ...
            Text(
                text = stringResource(R.string.onb_permission_subtitle),
            ...
            if (uiState.showRationale) {
                Card(
                    ...
                    Text(
                        text = stringResource(R.string.onb_rationale_message),
                        style = MaterialTheme.typography.bodyMedium,
