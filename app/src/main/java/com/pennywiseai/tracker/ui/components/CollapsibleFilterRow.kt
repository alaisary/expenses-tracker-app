        ...
        Row(
            ...
            Text(
                text = if (activeFilterCount > 0) {
                    stringResource(R.string.comp_more_filters_active, activeFilterCount)
                } else {
                    stringResource(R.string.comp_more_filters)
                },
            ...
            Icon(
                ...
                contentDescription = if (isExpanded) stringResource(R.string.comp_collapse) else stringResource(R.string.comp_expand),
                modifier = Modifier
