...
fun getCustomLightColorScheme(accent: AccentColor): ColorScheme {
    ...
    return lightColorScheme(
        ...
        inverseSurface = Color(0xFF1B1F1C),
        inverseOnSurface = Color(0xFFEAF0EB),
        error = Dawn_Love,
        ...
        surfaceDim = Color(0xFFE6EFE7),
        surfaceContainer = Color(0xFFF3F7F3),
        surfaceContainerHigh = Color(0xFFECF2ED),
        surfaceContainerHighest = Color(0xFFE1EBE3),
        surfaceContainerLow = Color(0xFFFBFDFB),
