...
fun CashFlowCard(
    ...
    PennyWiseCardV2(
        ...
        Text(
            text = stringResource(R.string.cards_money_in_motion),
            style = MaterialTheme.typography.titleSmall,
            fontWeight = FontWeight.SemiBold,
            color = MaterialTheme.colorScheme.onSurface
        )
        Text(
            text = stringResource(R.string.cards_channels_outside_net),
        ...
        FlowRow(
            ...
            for (ch in channels) {
                ...
                ChannelChip(
                    label = when (ch.label) {
                        "Credit" -> stringResource(R.string.cards_credit)
                        "Invested" -> stringResource(R.string.cards_invested)
                        "Transferred" -> stringResource(R.string.cards_transferred)
                        else -> ch.label
                    },
                    amount = ch.amount,
                    currency = currency,
