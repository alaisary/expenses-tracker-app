...
fun TransactionItem(
    ...
    val creditLabel = stringResource(R.string.cards_credit)
    val transferLabel = stringResource(R.string.cards_transfer)
    val investmentLabel = stringResource(R.string.cards_investment)
    val recurringLabel = stringResource(R.string.cards_recurring)
    val businessLabel = stringResource(R.string.cards_business)
    val excludedLabel = stringResource(R.string.cards_excluded)
    val balanceAfterText = transaction.balanceAfter?.let { balance ->
        stringResource(R.string.cards_bal_value, CurrencyFormatter.formatCurrency(balance, transaction.currency))
    }

    val localizedCategory = localizedCategoryName(transaction.category)

    val subtitle = remember(transaction, dateTimeText, isEffectivelyBusiness, creditLabel, transferLabel, investmentLabel, recurringLabel, businessLabel, excludedLabel, balanceAfterText, localizedCategory) {
        buildList {
