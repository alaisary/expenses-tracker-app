...
import com.pennywiseai.tracker.ui.components.CurrencyAmount
...
fun BalanceCard(
    ...
    /**
     * When false the collapsed view omits the "spent this month" header — used
     * on Home where [com.pennywiseai.tracker.ui.components.HeroSpendCard] already
     * leads with that figure, so it isn't shown twice.
     */
    showSpendHeader: Boolean = true,
) {
    ...
    val changeText = if (isPositive) stringResource(R.string.cards_more_vs_last_month, absPercent) else stringResource(R.string.cards_less_vs_last_month, absPercent)
        ...
        PennyWiseCardV2(
            ...
            Column(
                ...
                if (!isExpanded) {
                    ...
                    Column(
                        ...
                        if (accountBalances.isNotEmpty()) {
                            ...
                            Row(
                                ...
                                if (isBalanceHidden) {
                                    Text(
                                        text = stringResource(R.string.cards_balance_masked),
                                        style = PennyWiseText.amountSmall,
                                        color = MaterialTheme.colorScheme.onSurfaceVariant
                                    )
                                } else {
                                    Text(
                                        text = stringResource(R.string.cards_balance_label),
                                        style = PennyWiseText.amountSmall,
                                        color = MaterialTheme.colorScheme.onSurfaceVariant
                                    )
                                    CurrencyAmount(
                                ...
                                if (accountBalances.size > 1) {
                                    Text(
                                        text = stringResource(R.string.cards_accounts_suffix, accountBalances.size),
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        ...
                        if (spendingHistory.isNotEmpty()) {
                            ...
                            if (lastMonthSpendingHistory.isNotEmpty()) {
                                ...
                                Row(
                                    ...
                                    Text(
                                        text = stringResource(R.string.cards_this_month),
                                    ...
                                    Spacer(modifier = Modifier.width(Spacing.xs))
                                    Text(
                                        text = stringResource(R.string.cards_last_month),
                                        style = MaterialTheme.typography.labelSmall,
                                        color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.5f)
                                    )
                                }
                        ...
                        if (accountBalances.isNotEmpty()) {
                            ...
                            Text(
                                text = stringResource(R.string.cards_accounts),
                                style = MaterialTheme.typography.labelMedium,
                                color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f),
                                fontWeight = FontWeight.Medium
                            )
                                ...
                                Row(
                                    ...
                                    Text(
                                        ...
                                        text = if (account.accountLast4 == AccountBalanceEntity.WALLET_ACCOUNT_MARKER) {
                                            ...
                                            stringResource(R.string.cards_account_number, account.bankName, account.accountLast4)
                                        },
                                        style = MaterialTheme.typography.bodySmall,
                            ...
                            if (creditCards.isNotEmpty()) {
                                Spacer(modifier = Modifier.height(Spacing.sm))
                                Text(
                                    text = stringResource(R.string.cards_credit_cards),
                                    style = MaterialTheme.typography.labelMedium,
                                    color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f),
                                    fontWeight = FontWeight.Medium
                                )
                                ...
                                creditCards.forEach { card ->
                                    Row(
                                        ...
                                        Text(
                                            text = stringResource(R.string.cards_account_number, card.bankName, card.accountLast4),
                                            style = MaterialTheme.typography.bodySmall,
                                            color = MaterialTheme.colorScheme.onSurface
                                        )
                                        CurrencyText(
                            ...
                            Row(
                                ...
                                Text(
                                    text = stringResource(R.string.cards_total),
                                    style = MaterialTheme.typography.bodySmall,
                                    color = MaterialTheme.colorScheme.onSurface,
                                    fontWeight = FontWeight.Bold
                                )
                            ...
                            if (isApproximate) {
                                Spacer(modifier = Modifier.height(Spacing.xs))
                                Text(
                                    text = stringResource(R.string.cards_approximate_note),
                                    style = MaterialTheme.typography.labelSmall,
                ...
                Icon(
                    ...
                    contentDescription = if (isExpanded) stringResource(R.string.cards_collapse) else stringResource(R.string.cards_expand),
...
private fun SpendingAmountHeader(
    ...
    Text(
        text = stringResource(R.string.cards_spent_this_month),
        style = MaterialTheme.typography.bodySmall,
        color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f),
        fontWeight = FontWeight.Medium
    )
...
private fun CurrencyChip(
    ...
    Surface(
        ...
        Row(
            ...
            Icon(
                imageVector = Icons.Default.KeyboardArrowDown,
                contentDescription = stringResource(R.string.cards_change_currency),
