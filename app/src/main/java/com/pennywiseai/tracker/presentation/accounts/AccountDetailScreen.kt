...
fun AccountDetailScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                SectionHeaderV2(
                    title = stringResource(R.string.acct_transactions, uiState.transactions.size)
                )
            }
            ...
            if (uiState.transactions.isEmpty() && !uiState.isLoading) {
                item {
                    PennyWiseEmptyState(
                        ...
                        headline = stringResource(R.string.acct_no_transactions),
                        description = stringResource(R.string.acct_no_transactions_desc)
                    )
                }
            } else {
                items(
            ...
            Row(
                ...
                Column {
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.acct_balance_trend),
                ...
                Icon(
                    ...
                    contentDescription = if (isExpanded) stringResource(R.string.acct_collapse) else stringResource(R.string.acct_expand),
                    modifier = Modifier
    ...
    PennyWiseCardV2(
        ...
        Column(
            ...
            if (isCreditCard) {
                // Credit card layout
                Text(
                    text = stringResource(R.string.acct_available_credit),
                ...
                if (balance > BigDecimal.ZERO) {
                    Spacer(modifier = Modifier.height(Spacing.xs))
                    CurrencyText(
                        text = stringResource(R.string.acct_outstanding_colon, CurrencyFormatter.formatCurrency(balance, primaryCurrency)),
                        style = MaterialTheme.typography.bodySmall,
                    ...
                    if (billedOutstanding != null && unbilledOutstanding != null) {
                        ...
                        Row(
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                ...
                                Text(
                                    text = stringResource(R.string.acct_billed),
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                ...
                                Text(
                                    text = stringResource(R.string.acct_unbilled),
                                    style = MaterialTheme.typography.labelSmall,
                                    color = MaterialTheme.colorScheme.onSurfaceVariant
                                )
                            }
                ...
                Text(
                    text = stringResource(R.string.acct_current_balance),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Spacer(modifier = Modifier.height(Spacing.xs))
    ...
    PennyWiseCardV2(
        ...
        Column(
            ...
            Row(
                ...
                StatisticItem(
                    label = stringResource(R.string.acct_income),
                ...
                StatisticItem(
                    label = stringResource(R.string.acct_expenses),
                ...
                StatisticItem(
                    label = stringResource(R.string.acct_net),
                ...
                Column(
                    ...
                    Row(
                        ...
                        transaction.balanceAfter?.let { balance ->
                            CurrencyText(
                                text = stringResource(R.string.acct_balance_after, CurrencyFormatter.formatCurrency(balance, primaryCurrency)),
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                        }
            ...
            Column(
                ...
                when (transaction.transactionType) {
                    TransactionType.CREDIT -> Icon(
                        ...
                        contentDescription = stringResource(R.string.acct_credit),
                        modifier = Modifier.size(Dimensions.Icon.small),
                        tint = amountColor
                    )
                    TransactionType.TRANSFER -> Icon(
                        Icons.Default.SwapHoriz,
                        contentDescription = stringResource(R.string.acct_transfer),
                        modifier = Modifier.size(Dimensions.Icon.small),
                        tint = amountColor
                    )
                    TransactionType.INVESTMENT -> Icon(
                        Icons.AutoMirrored.Filled.ShowChart,
                        contentDescription = stringResource(R.string.acct_investment),
                        modifier = Modifier.size(Dimensions.Icon.small),
                        tint = amountColor
                    )
                    else -> {}
