...
private fun BrandHeader(isMember: Boolean) {
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            Text(
                text = stringResource(R.string.feat_upgrade_brand_title),
            ...
            Text(
                text = if (isMember) {
                    stringResource(R.string.feat_upgrade_brand_subtitle_member)
                } else {
                    stringResource(R.string.feat_upgrade_brand_subtitle_upgrade)
                },
...
private fun SupportNote() {
    Row(
        ...
        Text(
            text = stringResource(R.string.feat_upgrade_support_note),
    ...
    Column(
        ...
        Button(
            ...
            if (state.isPurchasing) {
                ...
                Text(
                    text = selectedPlan?.ctaLabel() ?: stringResource(R.string.feat_upgrade_select_plan),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.SemiBold,
                )
            }
...
private val PRO_FEATURES = listOf(
    R.string.feat_upgrade_feature_rules,
    R.string.feat_upgrade_feature_pdf,
    R.string.feat_upgrade_feature_csv,
    R.string.feat_upgrade_feature_merge,
)
...
private fun IncludesBlock() {
    Column(
        ...
        Text(
            text = stringResource(R.string.feat_upgrade_includes),
            style = MaterialTheme.typography.titleSmall,
            fontWeight = FontWeight.SemiBold,
...
private fun TrustRow(
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            Text(
                text = stringResource(R.string.feat_upgrade_cancel_anytime),
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            Dot()
            Text(
                text = stringResource(R.string.feat_upgrade_on_device_data),
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            Dot()
            TextButton(
                ...
                Text(
                    text = stringResource(R.string.feat_upgrade_restore),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.primary,
        ...
        if (liveCatalogEmpty) {
            Spacer(Modifier.height(Spacing.xs))
            Text(
                text = stringResource(R.string.feat_upgrade_prices_disclaimer),
...
private fun CelebrationContent(onContinue: () -> Unit) {
    ...
    Column(
        ...
        Column(
            ...
            EyebrowChip(text = stringResource(R.string.feat_upgrade_welcome), isAccent = true)
            Spacer(Modifier.height(Spacing.md))
            Text(
                text = stringResource(R.string.feat_upgrade_celebrate_title),
            ...
            Spacer(Modifier.height(Spacing.xs))
            Text(
                text = stringResource(R.string.feat_upgrade_celebrate_subtitle),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                textAlign = TextAlign.Center,
            )
            ...
            Button(
                ...
                Text(
                    text = stringResource(R.string.feat_upgrade_continue),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.SemiBold,
                )
            }
...
private fun MemberCard() {
    Surface(
        ...
        Column(
            ...
            EyebrowChip(text = stringResource(R.string.feat_upgrade_active), isAccent = true)
            Spacer(Modifier.height(Spacing.md))
            Text(
                text = stringResource(R.string.feat_upgrade_all_unlocked),
                style = MaterialTheme.typography.titleLarge,
                fontWeight = FontWeight.SemiBold,
                color = MaterialTheme.colorScheme.onSurface,
                textAlign = TextAlign.Center,
...
private fun ManageRow(onRestore: () -> Unit) {
    ...
    Row(
        ...
        TextButton(
            ...
            Text(
                text = stringResource(R.string.feat_upgrade_manage_subscription),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.primary,
                fontWeight = FontWeight.Medium,
            )
