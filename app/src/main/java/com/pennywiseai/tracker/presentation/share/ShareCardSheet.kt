...
fun ShareCardSheet(
    ...
    ModalBottomSheet(onDismissRequest = onDismiss, sheetState = sheetState) {
        Column(
            ...
            Text(
                text = stringResource(R.string.feat_share_no_amounts),
            ...
            Button(
                ...
                Text(stringResource(R.string.feat_share_share), modifier = Modifier.padding(start = Spacing.sm))
            }

            TextButton(onClick = { showCustomise = !showCustomise }) {
                Text(if (showCustomise) stringResource(R.string.feat_share_done) else stringResource(R.string.feat_share_customise))
            }
            ...
            AnimatedVisibility(visible = showCustomise) {
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.feat_share_show),
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                        FilterChip(
                            ...
                            label = { Text(stringResource(R.string.feat_share_transactions)) },
                        )
                        FilterChip(
                            ...
                            label = { Text(stringResource(R.string.feat_share_subscriptions)) },
                        )
                    }
                    if (!hasSubscriptions) {
                        Text(
                            text = stringResource(R.string.feat_share_no_subs_detected),
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                    ...
                    Text(
                        text = stringResource(R.string.feat_share_period),
                        style = MaterialTheme.typography.labelLarge,
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                        FilterChip(
                            ...
                            label = { Text(stringResource(R.string.feat_share_this_month)) },
                        )
                        FilterChip(
                            ...
                            label = { Text(stringResource(R.string.feat_share_last_month)) },
                        )
                        FilterChip(
                            ...
                            label = { Text(stringResource(R.string.feat_share_all_time)) },
                        )
                    }
                }
            }
