...
fun MarkAsPaidSheet(
    ...
    val eyebrowText = if (isIncome) stringResource(R.string.sched_eyebrow_mark_received) else stringResource(R.string.sched_eyebrow_mark_paid)
    val ctaPrefix = if (isIncome) stringResource(R.string.sched_mark_received) else stringResource(R.string.sched_mark_paid)
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            if (isPaidThisCycle) {
                androidx.compose.material3.Surface(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(
                                R.string.sched_already_marked_paid_on,
            ...
            if (candidates.isNotEmpty()) {
                Text(
                    text = stringResource(R.string.sched_matching_payments, candidates.size),
            ...
            Text(
                text = stringResource(R.string.sched_when),
                style = MaterialTheme.typography.labelMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            Spacer(Modifier.height(Spacing.sm))
            ...
            Button(
                ...
                CurrencyText(
                    text = stringResource(
                        R.string.sched_cta_with_amount,
                        ctaPrefix,
            ...
            Text(
                text = if (isIncome) {
                    stringResource(R.string.sched_income_roll_schedule, subscription.currency)
                } else {
                    stringResource(R.string.sched_expense_roll_schedule)
                },
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                textAlign = TextAlign.Center,
...
private fun CandidateCard(
    ...
    androidx.compose.material3.Surface(
        ...
        Row(
            ...
            Icon(
                imageVector = Icons.Outlined.CheckCircle,
                contentDescription = stringResource(R.string.sched_link_this_payment),
...
private fun OrDivider() {
    Row(
        ...
        Text(
            text = stringResource(R.string.sched_or_mark_today),
...
private fun DateChips(
    ...
    Row(
        ...
        FilterChip(
            ...
            label = { Text(stringResource(R.string.sched_today)) },
        ...
        FilterChip(
            ...
            label = { Text(stringResource(R.string.sched_yesterday)) },
            colors = FilterChipDefaults.filterChipColors(
                selectedContainerColor = MaterialTheme.colorScheme.primaryContainer,
                selectedLabelColor = MaterialTheme.colorScheme.onPrimaryContainer,
            ),
            ...
            label = {
                Text(
                    text = if (isCustom) {
                        ...
                        stringResource(R.string.sched_pick_date)
                    },
                )
            },
