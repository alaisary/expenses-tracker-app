...
enum class DateRange(@StringRes val labelRes: Int) {
    LAST_7_DAYS(R.string.filter_range_last_7_days),
    LAST_30_DAYS(R.string.filter_range_last_30_days),
    LAST_3_MONTHS(R.string.filter_range_last_3_months),
    LAST_6_MONTHS(R.string.filter_range_last_6_months),
    LAST_YEAR(R.string.filter_range_last_year),
    ALL_TIME(R.string.filter_time_all_time)
}