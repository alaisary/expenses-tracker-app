...
fun RecurringTransactionsScreen(
    ...
    PennyWiseScaffold(
        title = stringResource(R.string.sched_recurring),
        navigationIcon = {
            IconButton(onClick = onNavigateBack) {
                Icon(Icons.AutoMirrored.Filled.ArrowBack, contentDescription = stringResource(R.string.sched_back))
            }
        },
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(Icons.Default.Add, contentDescription = stringResource(R.string.sched_add_recurring_transaction))
            }
        }
    ) { padding ->
        if (templates.isEmpty()) {
            Box(modifier = Modifier.fillMaxSize().padding(padding)) {
                PennyWiseEmptyState(
                    ...
                    headline = stringResource(R.string.sched_empty_recurring_headline),
                    description = stringResource(R.string.sched_empty_recurring_description)
                )
            }
        ...
        LazyColumn(
            ...
            if (active.isNotEmpty()) {
                item { SectionHeaderV2(title = stringResource(R.string.sched_active)) }
            ...
            if (paused.isNotEmpty()) {
                item { SectionHeaderV2(title = stringResource(R.string.sched_paused)) }
...
private fun RecurringFrequency.labelRes(): Int = when (this) {
    RecurringFrequency.DAILY -> R.string.filter_frequency_daily
    RecurringFrequency.WEEKLY -> R.string.filter_frequency_weekly
    RecurringFrequency.MONTHLY -> R.string.filter_frequency_monthly
}
...
private fun RecurringItem(
    ...
    PennyWiseCardV2(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = template.merchantName.ifBlank { stringResource(R.string.sched_untitled) },
                    style = MaterialTheme.typography.bodyLarge,
                    fontWeight = FontWeight.Medium
                )
                Text(
                    text = stringResource(
                        R.string.sched_frequency_next,
                        stringResource(template.frequency.labelRes()),
            ...
            Box {
                IconButton(onClick = { showMenu = true }) {
                    Icon(Icons.Default.MoreVert, contentDescription = stringResource(R.string.sched_more_options))
                }
                DropdownMenu(expanded = showMenu, onDismissRequest = { showMenu = false }) {
                    DropdownMenuItem(
                        text = { Text(if (template.isActive) stringResource(R.string.sched_pause) else stringResource(R.string.sched_resume)) },
                        onClick = {
                            showMenu = false
    ...
    if (showDeleteConfirm) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.sched_delete_recurring_title)) },
            text = { Text(stringResource(R.string.sched_delete_recurring_message, template.merchantName)) },
            confirmButton = {
...
private fun RecurringEditorDialog(
    ...
    val dayOfWeekNames = listOf(
        stringResource(R.string.sched_day_mon),
        stringResource(R.string.sched_day_tue),
        stringResource(R.string.sched_day_wed),
        stringResource(R.string.sched_day_thu),
        stringResource(R.string.sched_day_fri),
        stringResource(R.string.sched_day_sat),
        stringResource(R.string.sched_day_sun)
    )

    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text(if (form.id == 0L) stringResource(R.string.sched_new_recurring) else stringResource(R.string.sched_edit_recurring)) },
        text = {
            Column(
                modifier = Modifier.fillMaxWidth(),
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(R.string.sched_amount)) },
                        singleLine = true,
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(R.string.sched_currency)) },
                        singleLine = true,
                ...
                ExposedDropdownMenuBox(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {},
                        readOnly = true,
                        label = { Text(stringResource(R.string.sched_category)) },
                ...
                ExposedDropdownMenuBox(
                    ...
                    OutlinedTextField(
                        value = stringResource(state.frequency.labelRes()),
                        onValueChange = {},
                        readOnly = true,
                        label = { Text(stringResource(R.string.sched_frequency)) },
                ...
                when (state.frequency) {
                    RecurringFrequency.MONTHLY -> {
                        OutlinedTextField(
                            ...
                            label = { Text(stringResource(R.string.sched_day_of_month)) },
                            singleLine = true,
                    ...
                    RecurringFrequency.WEEKLY -> {
                        ExposedDropdownMenuBox(
                            ...
                            OutlinedTextField(
                                value = state.dayOfWeek?.let { dayOfWeekNames[it - 1] } ?: stringResource(R.string.sched_any),
                                onValueChange = {},
                                readOnly = true,
                                label = { Text(stringResource(R.string.sched_day_of_week)) },
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.sched_note_optional)) },
                    singleLine = true,
                    modifier = Modifier.fillMaxWidth()
                )
                ...
                Row(
                    ...
                    Text(stringResource(R.string.sched_active), style = MaterialTheme.typography.bodyLarge)
                    Switch(
        ...
        confirmButton = {
            TextButton(enabled = state.isValid, onClick = { onSave(state) }) { Text(stringResource(R.string.sched_save)) }
        },
        dismissButton = {
