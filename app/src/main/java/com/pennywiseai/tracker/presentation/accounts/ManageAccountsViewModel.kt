    ...
    fun addAccount() {
        ...
        viewModelScope.launch {
            ...
            if (existingAccount != null) {
                _formState.update { it.copy(errorMessage = context.getString(R.string.vm_account_already_exists)) }
                return@launch
            }
            ...
            try {
                ...
                if (card != null && hasBalance) {
                    try {
                        ...
                        val message = context.getString(R.string.vm_card_linked_balance, CurrencyFormatter.formatCurrency(card.lastBalance, card.currency))
                        ...
                        _uiState.update { it.copy(successMessage = context.getString(R.string.vm_card_linked_balance_failed)) }
                    }
                } else {
                    // No balance to copy, just show link success
                    _uiState.update { it.copy(successMessage = context.getString(R.string.vm_card_linked)) }
                }
                ...
                _uiState.update { 
                    it.copy(errorMessage = context.getString(R.string.vm_card_link_failed, e.message))
                }
            }
        }
    }
    ...
    fun deleteCard(cardId: Long) {
        viewModelScope.launch {
            try {
                ...
                _uiState.update { it.copy(successMessage = context.getString(R.string.vm_card_deleted)) }
                ...
                _uiState.update { 
                    it.copy(errorMessage = context.getString(R.string.vm_card_delete_failed, e.message))
                }
            }
        }
    }
        ...
        viewModelScope.launch {
            try {
                ...
                if (existing == null) {
                    ...
                    _uiState.update {
                        it.copy(errorMessage = context.getString(R.string.vm_card_missing))
                    }
                    return@launch
                }
                ...
                _uiState.update { it.copy(successMessage = context.getString(R.string.vm_card_updated)) }
                delay(2000)
                _uiState.update { it.copy(successMessage = null) }
                loadCards()
            } catch (e: Exception) {
                ...
                _uiState.update {
                    it.copy(errorMessage = context.getString(R.string.vm_card_update_failed, e.message))
                }
            }
        }
    }
            ...
            try {
                ...
                _uiState.update {
                    it.copy(
                        ...
                        successMessage = context.getString(R.string.vm_account_deleted, deletedCount)
                    )
                }
                ...
                _uiState.update {
                    it.copy(errorMessage = context.getString(R.string.vm_account_delete_failed, e.message))
                }
            }
        }
    }
    ...
    fun mergeAccounts(
        ...
        viewModelScope.launch {
            try {
                ...
                if (sameAccount) {
                    _uiState.update { it.copy(errorMessage = context.getString(R.string.vm_merge_same_account)) }
                    return@launch
                }
                if (!source.currency.equals(target.currency, ignoreCase = true)) {
                    _uiState.update {
                        it.copy(errorMessage = context.getString(R.string.vm_merge_currency_mismatch, source.currency, target.currency))
                    }
                    return@launch
                }
                if (source.isCreditCard != target.isCreditCard) {
                    _uiState.update {
                        it.copy(errorMessage = context.getString(R.string.vm_merge_credit_mismatch))
                    }
                    return@launch
                }
    ...
    fun setAccountProfile(bankName: String, accountLast4: String, profileId: Long) {
        viewModelScope.launch {
            try {
                ...
                _uiState.update { it.copy(errorMessage = context.getString(R.string.vm_account_profile_failed, e.message)) }
            }
        }
    }
    ...
    fun setAccountAlias(bankName: String, accountLast4: String, alias: String?) {
        viewModelScope.launch {
            try {
                ...
                _uiState.update { it.copy(errorMessage = context.getString(R.string.vm_account_rename_failed, e.message)) }
            }
        }
    }
    ...
    fun setLowBalanceThreshold(bankName: String, accountLast4: String, threshold: java.math.BigDecimal?) {
        viewModelScope.launch {
            try {
                ...
                _uiState.update { it.copy(errorMessage = context.getString(R.string.vm_account_alert_failed, e.message)) }
            }
        }
    }
    ...
    fun applyPendingProfileReassign() {
        ...
        viewModelScope.launch {
            try {
                ...
                _uiState.update { it.copy(errorMessage = context.getString(R.string.vm_move_transactions_failed, e.message)) }
            } finally {
    ...
    fun editAccount(
        ...
        viewModelScope.launch {
            try {
                ...
                _uiState.update {
                    it.copy(successMessage = context.getString(R.string.vm_account_updated))
                }
                ...
                _uiState.update {
                    it.copy(errorMessage = context.getString(R.string.vm_account_update_failed, e.message))
                }
            }
        }
    }
