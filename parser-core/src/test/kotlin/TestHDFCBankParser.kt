...
T&C. Ignore if paid""",
            ...
            // Credit-card refund — incoming credit to the card. The parser used
            // to drop these silently because the message lacks the standard
            // "debited/credited/spent/..." keywords.
            ParserTestCase(
